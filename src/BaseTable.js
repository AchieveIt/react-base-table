...
class BaseTable extends React.PureComponent {
  ...
  _getRowHeight(rowIndex) {
    ...
    if (this._data[rowIndex]) {
      console.log('the data exists', this._rowHeightMap[this._data[rowIndex][rowKey]])
      return this._rowHeightMap[this._data[rowIndex][rowKey]] || estimatedRowHeight;
    } else {
      console.log('data doesnt exist or hasnt been measured', this._rowHeightMap, this._data, this._data[rowIndex])
